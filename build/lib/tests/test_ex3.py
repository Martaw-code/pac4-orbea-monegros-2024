"""
Test module for ex3.py using unittest
"""

import unittest
import os
import pandas as pd
from modules.ex3 import minutes_002040, create_time_grouped_column, groupby_time_grouped, plot_histogram
...
class TestEx3(unittest.TestCase):
    ...
    def test_plot_histogram(self):
        """Comprova que la funció plot_histogram genera un fitxer PNG."""
        df = pd.DataFrame({
            "time_grouped": ["00:00", "00:00", "00:20"],
            "count": [2, 2, 1]
        })
        output_path = "img/test_histogram.png"
        # Assegurem que no existeix abans
